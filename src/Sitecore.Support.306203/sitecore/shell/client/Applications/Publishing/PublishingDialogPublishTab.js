            ...
            var toggleDisplay = function () {
                ...
                if (hasId) {
                    ...
                    this.SearchDataSourceMessages.on("change:HasData",
                        function () {
                            // Sitecore.Support.306203 +++
                            //var message = Utils.findItem(this.SearchDataSourceMessages.Items, Constants.itemIds.fullsitePublishWarning);
                            var message = Utils.findItem(Constants.SitecoreSupportSearchDataSourceMessages.Items, Constants.itemIds.fullsitePublishWarning);
                            // Sitecore.Support.306203 ---
