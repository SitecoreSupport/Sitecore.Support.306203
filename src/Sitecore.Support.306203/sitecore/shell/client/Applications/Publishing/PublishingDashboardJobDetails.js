(function (Speak) {
    ...
    Speak.pageCode(["entityService", "publishingConstants", "publishingUtils", "publishingShared"], function (entityService, Constants, Utils, Shared) {
